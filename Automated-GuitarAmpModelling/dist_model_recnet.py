...
def main(args):
    ...
    optimiser = torch.optim.Adam(network.parameters(), lr=args.learn_rate, weight_decay=1e-12)
...
if __name__ == "__main__":
    ...
    prsr.add_argument('--validation_f', '-vfr', type=int, default=1, help='Validation Frequency (in epochs)')
    # TO DO
